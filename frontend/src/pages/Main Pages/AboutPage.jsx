    ...
    <>
      <div className='w-full h-auto my-20 bg-white px-10'>
        <div className='p-4 md:p-10 w-full flex flex-col md:flex-row justify-around items-center'>
          <div className='w-full text-center md:w-1/2 md:text-start mb-10 md:my-0 pl-4'>
            <p className="text-amber-900 font-gurajadaRegular text-[64px] md:text-[64px]">మా   ప్రస్తావన</p>
            <h1 className='text-green-4 font-leagueSpartanSemiBold text-[40px] md:text-[96px] mb-2 leading-tight'>About us!!</h1>
        ...
        <div className='hidden md:block '>
          <div className='my-20 w-full flex flex-col justify-center items-center'>
            <p className="text-amber-900 font-gurajadaRegular text-[64px] my-2">మా   ప్రస్తావన</p>
        ...
        <div className='flex flex-col justify-center items-center my-10'>
          <p className="text-amber-900 font-leagueSpartanMedium text-[64px] my-2">Our Team</p>
          <p className='text-red-400 text-lg leading-6 w-2/3 text-center font-leagueSpartanExtrsLight text-[24px]'>
            More than 3 lakhs patients consulted personally at Prakruti Ashram. The consultation and food is served for 
            FREE since the inception of this Ashram.
          </p>
          <div className='flex flex-wrap justify-center'>
            {team.map((mem, index) => (
              <div className='p-10 flex flex-col justify-center items-center'>
                ...
                <div className='mt-8'>
                  <p className='font-leagueSpartanRegular'>{mem.name}</p>
                  <p className='font-leagueSpartanExtrsLight flex justify-center'>{mem.position}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <div class="bg-green-4 p-10 w-full">
        <div className='flex flex-col justify-center items-center mb-10'>
          <h1 className='text-white font-leagueSpartanMedium text-[64px]'>Address</h1>
        </div>
        <div className='flex flex-col md:flex-row w-full'>
          ...
          <div className='w-full md:w-1/2 text-white ml-2 font-tenaliRamaKrishnaRegular'>
