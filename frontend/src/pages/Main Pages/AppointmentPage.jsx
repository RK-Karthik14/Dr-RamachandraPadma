      ...
      <div className='w-full h-auto mb-10 bg-white'>
        <div className='p-4 md:p-10 w-full flex flex-col md:flex-row justify-around items-center'>
          <div className='w-full text-center md:w-1/2 md:text-start mb-10 md:my-0 pl-4'>
            ...
            <h1 className='text-green-4 font-leagueSpartanSemiBold text-[40px] md:text-[100px] mb-2 leading-tight'>Harmony Heal</h1>
        ...
        <div 
          ...
          <h1 className='text-white text-[64px] mb-10 mt-5 font-leagueSpartanMedium text-center'>Book your Appointment</h1>
          <form onSubmit={handleSubmit(appointmentData)} className='w-full flex flex-col justify-center items-center'>
            <div className='w-full flex flex-col md:flex-row'>
              ...
              <div className='w-full md:w-1/2 order-3 md:order-1'>
                <div className='p-8 bg-white rounded-[40px] shadow-lg mt-4 md:mx-5 md:mr-10'>
                  ...
                  <div className='mt-4'>
                    <p className='text-xs md:text-lg font-leagueSpartanLight'>
                      <span className='font-leagueSpartanRegular'>Instructions:</span><br />
                    ...
                    <>
                      ...
                      <div className='-mx-2 flex flex-wrap h-[90px] overflow-y-scroll admin-scrollbar'>
                        {slots.map((slot, index) => (
                          <div key={index} className='m-1 md:m-2 w-auto text-sm bg-white rounded-[5px] p-[1px] px-4 border-[1px] border-green-800 font-leagueSpartanRegular'>
                            {slot.time}
                          </div>
                        ))}
                      </div>
                      ...
                      <p className='font-leagueSpartanRegular'>No slots available on selected date</p>
                    )}
                </div>
              )}
              ...
              <div className='hidden md:block ml-12 w-full mt-5'>
                {slots.length !== 0 ? (
                  <>
                    ...
                    <p className='text-white font-leagueSpartanRegular'>No slots available on the selected date, please select another date</p>
                  )}
              </div>
            )}
            ...
            <div className='flex justify-center my-4'>
              <CommonButton type='submit' className='bg-white text-green-4 p-2 px-4 w-44 rounded-lg font-leagueSpartanSemiBold'>Pay Now</CommonButton>
            </div>
          </form>
        </div>

        <div className='flex flex-col justify-center items-center my-10 p-6'>
          <p className='text-green-700 text-3xl mb-10 mt-5 font-leagueSpartanMedium'>Know your Doctor</p>
