  ...
  return (
    <>
      <aside className="lg:static transition-all duration-300 bg-gray-1 min-h-screen">
        <div className={`font-leagueSpartanRegular fixed md:static md:h-full lg:flex flex-col justify-start items-start text-white bg-green-4 p-2 md:p-10 ${isExpanded ? "w-80 absolute lg:static h-full" : "w-6 hover:w-12 md:w-20 md:hover:20 static rounded-br-2xl rounded-tr-2xl"} md:rounded-none mb-2 transition-all duration-300`}>
          ...
          <div className={`${isExpanded ? "block" : "hidden"} md:block`}>
            <div className="w-full flex flex-col py-4">
              ...
              <Link
                ...
                className={`hover:bg-green-3 ${isActive('classbooked') ? 'bg-green-3' : ''} transition-all duration-300 rounded-2xl cursor-pointer flex ${isExpanded ? "p-4 m-1" : "-m-[8px] md:-m-[20px] h-10 w-10 flex justify-center my-2 md:my-4"}`}>
              ...
              <Link 
                ...
                className={`hover:bg-green-3 ${isActive('appointment') ? 'bg-green-3' : ''} transition-all duration-300 rounded-2xl cursor-pointer flex ${isExpanded ? "p-4 m-1" : "m-[8px] md:-m-[20px] h-10 w-10 flex justify-center my-2 md:my-4"}`}>
                  <span className="px-2 flex justify-center items-center text-lg">
              ...
              <Link 
                ...
                className={`hover:bg-green-3 ${isActive('youtube') ? 'bg-green-3' : ''} transition-all duration-300 rounded-2xl cursor-pointer flex ${isExpanded ? "p-4 m-1" : "-m-[8px] md:-m-[20px] h-10 w-10 flex justify-center my-2 md:my-4"}`}>
                  <span className="px-2 flex justify-center items-center text-lg">
              ...
              <Link 
                ...
                className={`hover:bg-green-3 ${isActive('payment') ? 'bg-green-3' : ''} transition-all duration-300 rounded-2xl cursor-pointer flex ${isExpanded ? "p-4 m-1" : "-m-[8px] md:-m-[20px] h-10 w-10 flex justify-center my-2 md:my-4"}`}>
              ...
              <Link 
                ...
                className={`hover:bg-green-3 ${isActive('users') ? 'bg-green-3' : ''} transition-all duration-300 rounded-2xl cursor-pointer flex ${isExpanded ? "p-4 m-1" : "-m-[8px] md:-m-[20px] h-10 w-10 flex justify-center my-2 md:my-4"}`}>
                  <span className="px-2 flex justify-center items-center text-lg">
              ...
              <Link 
                ...
                className={`hover:bg-green-3 ${isActive('slots') ? 'bg-green-3' : ''} transition-all duration-300 rounded-2xl cursor-pointer flex ${isExpanded ? "p-4 m-1" : "-m-[8px] md:-m-[20px] h-10 w-10 flex justify-center my-2 md:my-4"}`}>
                  <span className="px-2 flex justify-center items-center text-lg">
              ...
              <Link 
                ...
                className={`hover:bg-green-3 ${isActive('dcoter') ? 'bg-green-3' : ''} transition-all duration-300 rounded-2xl cursor-pointer flex ${isExpanded ? "p-4 m-1" : "-m-[8px] md:-m-[20px] h-10 w-10 flex justify-center my-2 md:my-4"}`}>
                  <span className="px-2 flex justify-center items-center text-lg">
          ...
          {isExpanded && (
            <div className="w-full flex flex-col justify-end flex-grow pb-16">
              <p className="text-gray-200 font-thin text-xl ml-[25%] font-leagueSpartanExtrsLight">Version 1.0</p>
            </div>
          )}
        </div>
      </aside>
