...
//     <>
//       <aside className={`lg:static bg-gray-1 transition-all duration-300`}>
//         <div className={`h-full lg:flex flex-col justify-start items-start text-white bg-green-4 p-6 md:p-10 ${isExpanded ? "w-80 absolute lg:static h-full" : "w-20 static"} rounded-br-3xl rounded-tr-3xl mb-2 transition-all duration-300`}>
//           <div className={`w-full flex justify-end ${isExpanded ? "" : "md:ml-6"}`}>
//             <button
...
//                 className={`hover:bg-green-3 ${isActive("profile") ? "bg-green-3" : ""} transition-all duration-300 rounded-2xl cursor-pointer flex ${isExpanded ? "p-4 m-1" : "-m-[8px] md:-m-[20px] h-10 w-10 flex justify-center my-2 md:my-2"}`}
//               >
//                 <span className="px-2 flex justify-center items-center text-lg">
...
//                 className={`hover:bg-green-3 ${isActive("appointment") ? "bg-green-3" : ""} transition-all duration-300 rounded-2xl cursor-pointer flex ${isExpanded ? "p-4 m-1" : "-m-[8px] md:-m-[20px] h-10 w-10 flex justify-center my-2 md:my-2"}`}
//               >
//                 <span className="px-2 flex justify-center items-center text-lg">
...
//                 className={`hover:bg-green-3 ${isActive("class") ? "bg-green-3" : ""} transition-all duration-300 rounded-2xl cursor-pointer flex ${isExpanded ? "p-4 m-1" : "-m-[8px] md:-m-[20px] h-10 w-10 flex justify-center my-2 md:my-2"}`}
//               >
//                 <span className="px-2 flex justify-center items-center text-lg">
