...
const DoctorProfile = ({image, name, text}) => {
    return (
        <div className=' my-16 flex justify-center'>
            <div className='relative w-full md:w-3/4 flex flex-col md:flex-row p-6 rounded-3xl shadow-lg  bg-green-3 text-white'>
                ...
                <div className='w-full md:w-4/5 mt-4 md:mt-0 md:ml-5'>
                    <h1 className='text-lg md:text-[25px] text-white font-leagueSpartanSemiBold'>{name}</h1>
                    <p className='text-sm my-2 font-tenaliRamaKrishnaRegular'>
                        {text} 
                    </p>
                </div>
            </div>
